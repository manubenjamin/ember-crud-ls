...
return Object.defineProperty(r,"__esModule",{value:!0}),r}catch(a){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("ember-crud-ls/app").default.create({name:"ember-crud-ls",version:"0.0.0+6d5edde3"})
